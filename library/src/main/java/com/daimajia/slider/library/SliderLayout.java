...
public class SliderLayout extends RelativeLayout {
    ...
    /**
     * IF true,it while stop backToFront when at the last postion
     */
    ...
    public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        disableSwipeRecycle = attributes.getBoolean(R.styleable.SliderLayout_disableSwipeRecycle, false);
        ...
        mSliderAdapter.setDisableSwipeRecycle(disableSwipeRecycle);
